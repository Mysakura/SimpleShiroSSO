package com.shirosso.appone.conf;

import com.example.app.common.entity.User;
import com.shirosso.appone.auth.PermissionRealm;
import com.shirosso.appone.interceptor.SSOFilter;
...
public class ShiroConfig {
    ...
    /**
     * 这里为了避免共享session的影响，我用的是默认的sessionDAO
     * @return
     */
    @Bean
